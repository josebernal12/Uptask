(function () {
    ...
    function mostrarTareas() {
        ...
        arrayTareas.forEach(tarea => {
            ...
            const opcioneDiv = document.createElement('DIV');
            opcioneDiv.classList.add('opciones');
            ...
            opcioneDiv.appendChild(btnEstadoTarea);
            opcioneDiv.appendChild(btnEliminarTarea);

            contenedorTareas.appendChild(nombreTarea);
            contenedorTareas.appendChild(opcioneDiv);
    ...
    function mostrarAlerta(mensaje, tipo, referencia) {
        //previene la creacioin de multiples alertas
